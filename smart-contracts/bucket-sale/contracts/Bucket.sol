...
contract BucketSale
{
    ...
    */
        ...
        internal
    {
        ...
        require(
            tokenOnSale.balanceOf(address(this)).add(totalExitedTokens) >= _bucketId.add(1).mul(bucketSupply), //UHOH: should be bucketCount, not bucketId+1
        ...
        returns(uint)
    {
        ...
        {
            return 0; // Do we still need this case? Is it redundant? If so should we keep it for secure reasonings?
        }
        else
        {
